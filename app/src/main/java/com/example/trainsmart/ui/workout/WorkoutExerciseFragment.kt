...
class WorkoutExerciseFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nSets = extractNumSets(exercise?.countReps!!)
    }
    ...
    override fun onCreateView(
        ...
        repetitionCountTextView.text = extractNumReps(exercise.countReps).toString()
        ...
        progressBar.setCounts = workout!!.exercises.map { extractNumSets(it.countReps) }.toTypedArray()
        return root
    }
